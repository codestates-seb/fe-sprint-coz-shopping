    ...
    <>
      {item.type === "Product" ? (
        <div style={{ width: "264px", height: "264px" }}>
          ...
          <Container>
            <LeftText>{item.title}</LeftText>
            <RightText>{item.discountPercentage + "%"}</RightText>
          </Container>
          <Container>
        ...
        <div style={{ width: "264px", height: "264px" }}>
          ...
          <Container>
            <LeftText style={{ fontWeight: "500" }}>{item.sub_title}</LeftText>
          </Container>
        </div>
      ) : item.type === "Brand" ? (
        <div style={{ width: "264px", height: "264px" }}>
          ...
          <Container>
            <LeftText>{item.brand_name}</LeftText>
            <RightText>관심고객수</RightText>
          </Container>
          <Container>
            <RightText style={{ fontWeight: "500" }}>
              {formatPrice(item.follower)}
            </RightText>
          </Container>
        </div>
      ) : null}
